...
def clean_age_data():
    df_age = pd.read_excel(
        "data/raw/londonboroughs.xlsx", sheet_name="Age London Boroughs"
    )
    ...
    young_ages = ["Aged 20 to 24 years", "Aged 25 to 29 years", "Aged 30 to 34 years"]
    ...
    df_age_features["young_ratio"] = (
        df_age_features["young_population"] / df_age_features["total_population"]
    )
