...
if __name__ == "__main__":
    test_profiles = [
        ...
        },
        {
            ...
            "youth_weight": 0.1,
            "centrality_weight": 0.2,
            "current_situation": "professional",
        ...
        },
        {
            ...
            "youth_weight": 0.6,
            "centrality_weight": 0.2,
            "current_situation": "young_professional",
            "stay_duration": "medium_term",
        },
        {
            "label": "🧘 Balanced user",
            "budget_weight": 0.3,
    ...
    for profile in test_profiles:
        ...
        for rec in top:
            print(
                f"{rec['borough']:25s} | score={rec['score']:.4f} | rent={rec['norm_rent']:.2f} | safety={rec['norm_crime']:.2f} | youth={rec['norm_youth']:.2f} | centrality={rec['norm_centrality']:.2f}"
            )
