  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12 text-white">
      ...
      <p className="mb-10 text-lg text-gray-300">
        ...
        to bring all of them closer to you. Whether you&#39;re moving, exploring
        or just dreaming, this platform helps you understand what each area has
        to offer, and even recommends matches based on your lifestyle.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-400">
          ...
          learns from your answers and applies them to borough data. It&#39;s
          like a local friend who knows the whole city, and just wants to help
