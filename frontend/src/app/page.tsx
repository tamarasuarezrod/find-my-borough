...
export default function HomePage() {
  ...
  return (
    <div className="text-center">
      <div
        className="relative h-[90vh] flex flex-col justify-center items-center text-white"
        style={{
      ...
      >
        ...
        <div className="flex gap-4 mt-4">
          <Link
            href="/match"
            className="bg-white text-black px-6 py-2 rounded-full shadow hover:scale-105 transition"
          >
            ✨ Get your match
          </Link>
